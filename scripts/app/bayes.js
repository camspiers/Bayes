...
//                            self.load_mathjax();
                            ...
                            self.load_js('//cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML', function () {
                ...
                update_calc: function () {
                    ...
                    if (self.config.num > 2) {
                        ...
                        for (i = 0; i < self.config.num; i += 1) {
                            ...
                            val = self.round(self.calculate(und.sortBy(calc, function (val, index) {
                                return index !== i;
                            })));
                ...
                load_js: function (url, cs, err) {
                    ...
                    if (_.isUndefined(js_promises[url])) {
